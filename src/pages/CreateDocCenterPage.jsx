          ...
          <div className="md:flex md:justify-center">
            <div className="p-3 md:w-deflaut md:flex">
                <div className="w-full">
                    <a href="/DocCenter"><h1 className="my-4 text-ft-light hover:text-ft hover:underline">New Document</h1></a>
                    <CreateDocForm campaign={(location.state!==null)?location.state.event:""}/>
...
export default CreateDocCenterPage;