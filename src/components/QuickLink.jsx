...
<div className='w-full '>
  <div className=''>
    ...
    <p className=''>*At most 15 links can be added</p>
             ...
             <div onClick={Link.length<=14? () => showCreateMobile():() => closeCreateMobile()} className='mt-4 flex'>
              <a className={Link.length<=14?('text-white bg-ft-light text-center w-full rounded px-3 py-2'):('pointer-events-none text-center w-full  text-white text-decoration-none bg-gray-500 rounded px-3 py-2')} >
              Create
             </a>
           </div>
...
<div className="flex">
  <table className=" flex w-full bg-white">
    ...
    {Link || Link.length !== 0 ?Link.map((campaignMobileHead) => {
        return (
      <tr className="pl-1 bg-ft-light flex flex-col mb-2 border border-slate-300" key={campaignMobileHead.linkId}>

            <th className='h-12 font-normal'>URL name(Eng)</th>
            <th className='h-12 font-normal'>URL name(Trad Chi)</th>
        
        <th className='h-12 font-normal'>URL name(Simp Chi)</th>
        <th className='h-12 font-normal'>URL</th>
        <th className='h-8 font-normal'>Edit</th>
        <th className='h-8 font-normal'>Delete</th>
      </tr>
    ...
    {Link.map((campaign) => {
        ...
        return (
          <tr className="flex flex-col border border-slate-300 mb-2" key={campaign.linkId}>
          
                 
            <td className='pl-3 pr-3 h-12'>{campaign.linkEngName}</td>
            <td className='pl-3 pr-3 h-12'>{campaign.linkChiName}</td>
            <td className='pl-3 pr-3 h-12'>{campaign.linkSimName}</td>
            <td className='pl-3 pr-3 h-12'>{campaign.url}</td>
...
<td className='pl-3 pr-3 h-8'>
        ...
        <a onClick={() => handleDelete(campaign.linkId)}>
...
:(
      <div className='w-deflaut px-2'>
        <div className='flex justify-content-between align-items-center my-3'>
          ...
          <a className={Link.length<=14?('text-white bg-ft-light rounded px-3 py-2'):('pointer-events-none text-white text-decoration-none bg-gray-500 rounded px-3 py-2')}>
            Create
          </a>
      </div>
