...
const ViewDocForm = (props) =>  {
  ...
  return (
    ...
    <>
     <div>
        ...
        <div className="form-row flex mx-3 my-5">  
            ...
            <label htmlFor="IFA/CA">Channel<span className='text-red-600'>*</span></label>
             <select
                 ...
                 className="bg-gray-200 w-full bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-ft-light focus:border-ft-light p-2.5"
                 value={IFACA}
                 name="ifaCaIndicator"
        ...
        <div className="form-row flex mx-3 my-5">  
            ...
            <label>Category:<span className='text-red-600'>*</span></label><br></br>
                <select disabled value={selectedMainCategory} onChange={handleMainCategoryChange} className="rounded border bg-gray-200 border-red-400 h-10 w-full">
            ...
            {subCategoryOptions && (
                ...
                <select disabled value={selectedSubCategory} onChange={handleSubCategoryChange} className="rounded border bg-gray-200 border-red-300 h-10 w-full">
     ...
     <button onClick={goBack} type="button" className="ml-4 text-ft-light ring-1 ring-ft-light bg-white hover:bg-ft hover:text-white rounded-md px-4 py-2 active:bg-white active:text-red-500 active:ring-1 active:ring-red-500 transition">Back</button>
        </div>
        </form>
